...
$conn->close();
?>
<p style = "margin-bottom:200px;margin-left: 500px;margin-right: 500px;font-size:20px;font-style: bold;font-family: ARIAL BLACK;color: yellow"><a href="http://localhost/adminlogin.html">GO BACK TO LOGIN PAGE!!</a></p>
</body>
</html>
